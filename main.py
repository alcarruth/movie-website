...
planes_trains_and_automobiles = Movie(
    ...
    wife (Laila Robbins) and kids, his flight is rerouted to a distant
    city in Kansas because of a freak snowstorm, and his sanity begins to
    fray. Worse yet, he is forced to bunk up with talkative Del Griffith
    (John Candy), whom he finds extremely annoying. Together they must
...
amy = Movie(
    ...
    portrait of the life and career of British singer/songwriter Amy
    Winehouse.
    """)
